...
PROBE_CHECKPOINT_DIR = PACKAGE_ROOT / "results" / "probe_runs"
...
def get_probe_train_config() -> dict:
    ...
    return {
        ...
        # --- chunk / data settings ---
        "start_chunk": 0,
        "end_chunk": 5,        # inclusive
        "norm_chunks": 3,      # first N chunks used for normalization
        "val_last_k": 1,        # how many last chunks to reserve for validation
